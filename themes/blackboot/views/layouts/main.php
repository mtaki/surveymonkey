				...
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Question', 'url'=>array('/questions/admin')),
							array('label'=>'Answer', 'url'=>array('/answers/admin')),
							array('label'=>'QnA', 'url'=>array('/qna/admin')),
							array('label'=>'Respondent', 'url'=>array('/Respondent/admin')),
