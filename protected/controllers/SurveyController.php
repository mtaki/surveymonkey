...
class SurveyController extends Controller
{
	...
	{
		$model=new Survey;
		$model1=Respondent::model()->findAllBySql("Select *from respondent where respondentcol=53981823");
	...
	public function actionCreate(){	
		...
		$str = file_get_contents("C:\wamp\www\surveymonkey\surveymonkey\survey\survey_list_20_10_2014.json",FILE_USE_INCLUDE_PATH,$context);
		$str=utf8_encode($str);
