...
class RespondentController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$id=$_GET['id'];
		$survey_id='\"'.$id.'\"';
		$cmd1 = 'curl -H "Authorization:bearer paTBz61kMlD0mPWrsaHR3921EuYbHlBvqU0GDZQ.5nahBvB1GbdZpbh2WnOzXY4SVpYnLumRCmREhFZltiwlnDA6qHIyCzumQSIkSUIheoQ=" -H "Content-Type: application/json" https://api.surveymonkey.net/v2/surveys/get_respondent_list?api_key=kbkujw7j2h7tudrnqtsr4xzt --data-binary "{\"survey_id\":'.$survey_id;
		...
		$str = file_get_contents("C:\wamp\www\surveymonkey\data\survey/respondent_survey_id_53981823.json",FILE_USE_INCLUDE_PATH,$context);
		$str=utf8_encode($str);
	...
	$command = Yii::app()->db->createCommand();
		...
		$model=Respondent::model()->findAllBySql("Select *from respondent where survey_id=53981823");
