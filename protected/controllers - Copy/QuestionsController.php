...
$context=stream_context_create($headers);
		...
		$id=$_GET['id'];
		$survey_id='\"'.$id.'\"';
		$cmd1 = 'curl -H "Authorization:bearer paTBz61kMlD0mPWrsaHR3921EuYbHlBvqU0GDZQ.5nahBvB1GbdZpbh2WnOzXY4SVpYnLumRCmREhFZltiwlnDA6qHIyCzumQSIkSUIheoQ=" -H "Content-Type: application/json" https://api.surveymonkey.net/v2/surveys/get_survey_details?api_key=u366xz3zv6s9jje5mm3495fk --data-binary "{\"survey_id\":'.$survey_id;
		$cmdline = $cmd1.'}"'." ".">"."C:\wamp\www\surveymonkey\data\survey/questions_survey_id_".$id.".json";
		system($cmdline);
		echo $cmdline;
$str = file_get_contents("C:\wamp\www\surveymonkey\surveymonkey\survey\question.json",FILE_USE_INCLUDE_PATH,$context);
$str=utf8_encode($str);
...
$command = Yii::app()->db->createCommand();
		...
		//print_r($value["pages"][0]["questions"][$i]["heading"]."=".$value["pages"][0]["questions"][$i]["question_id"]);
